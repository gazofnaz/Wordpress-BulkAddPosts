...
class Zip_All_Post_Attachments
{
    ...
    public function __construct( $parent ){
        ...
        $this->zip_locale = $upload_dir['basedir'].$upload_dir['subdir'].'/'.'all_'.$this->post_type_name.'s.zip';//where the zip is stored
        $this->zip_download_link = $upload_dir['url'].'/'.'all_'.$this->post_type_name.'s.zip';//Zip location to pass to frontend
